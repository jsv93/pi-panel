...
DEFAULT_TEMPLATE = {
    ...
    "display": {
        ...
        "mini_art": True,
        # Whole-screen multi-touch gesture. "off" or "lights" (toggle the
        # room). Works from any page and from standby, which is the point --
        # it is for leaving a room, not for operating the panel. Whether the
        # touch controller can report this many points is hardware; the panel's
